...
Expected input:
    yeast.csv with a target column named `localization_site` and 8 numeric feature columns.
...
def main() -> None:
    ...
    parser.add_argument("--data", type=str, default=DEFAULT_DATA_PATH, help="Path to yeast.csv")
